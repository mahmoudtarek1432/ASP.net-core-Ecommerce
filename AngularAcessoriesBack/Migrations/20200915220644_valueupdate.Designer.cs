...
namespace AngularAcessoriesBack.Migrations
{
    ...
    [Migration("20200915220644_valueupdate")]
    partial class valueupdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AngularAcessoriesBack.Models.Categories", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("AngularAcessoriesBack.Models.CategoryValues", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("AngularAcessoriesBack.Models.ProductFilters", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("AngularAcessoriesBack.Models.ProductFiltersValues", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("categoryValuesId");

                    b.Property<int?>("productFiltersId");

                    b.Property<int>("productId");

                    b.HasKey("Id");

                    b.HasIndex("categoryValuesId");

                    b.HasIndex("productFiltersId");

                    b.ToTable("ProductFiltersValues");
                });
            ...
            modelBuilder.Entity("AngularAcessoriesBack.Models.CategoryValues", b =>
                {
                    b.HasOne("AngularAcessoriesBack.Models.Categories", "category")
                        .WithMany("values")
            ...
            modelBuilder.Entity("AngularAcessoriesBack.Models.ProductFiltersValues", b =>
                {
                    b.HasOne("AngularAcessoriesBack.Models.CategoryValues", "categoryValues")
                        .WithMany("productFiltersValues")
                        .HasForeignKey("categoryValuesId");

                    b.HasOne("AngularAcessoriesBack.Models.ProductFilters", "productFilters")
                        .WithMany("productFiltersValues")
                        .HasForeignKey("productFiltersId");
                });
